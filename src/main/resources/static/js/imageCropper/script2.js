...
const popupValidateImg = document.getElementById("popupValidateImg");
// const editCropper = document.getElementById("editCropper");
// const deleteCropper = document.getElementById("deleteCropper");
...
applyButton.addEventListener("click", (e) => {
    ...
    $('img[id="previewImage"]').closest("img").show();
...
// editCropper.addEventListener("click", (e) => {
//     document.getElementById("popupContainer").style.display = "block";
// });
//
// deleteCropper.addEventListener("click", (e) => {
//     previewImg.src = "#";
//     fileInput.src = "#";
//     image.src = "#";
//
//     $('div').each(function() {
//         if($(this).find('img[id="image"]').attr('src') == "#"){
//             $('img[id="previewImage"]').closest("img").hide();
//             $('button[id="icon-button-edit"]').closest("button").hide();
//             $('button[id="icon-button-delete"]').closest("button").hide();
//             $('h4[id="chooseImg"]').closest("h4").show();
//         }
//     });
// });
