...
public class NotiEntity extends EntityBase implements Serializable {
    @Id
...
//    @ManyToOne
//    @JoinColumn(name = "deeplink_configure_id", referencedColumnName = "id", insertable = false, updatable = false)
//    private DeeplinkConfigure deeplinkConfigure;
}